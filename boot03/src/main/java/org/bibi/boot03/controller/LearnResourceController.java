package org.bibi.boot03.controller;

import org.bibi.boot03.entity.LearnResource;
...
public class LearnResourceController {
    ...
    public ModelAndView index(){
        ...
        learnList.add(bean);
        bean =new LearnResource("官方SpringBoot例子","官方SpriongBoot例子","https://github.com/spring-projects/spring-boot/tree/master/spring-boot-samples");
        learnList.add(bean);
        ...
        learnList.add(bean);
        ModelAndView modelAndView = new ModelAndView("LearnResource/index");
